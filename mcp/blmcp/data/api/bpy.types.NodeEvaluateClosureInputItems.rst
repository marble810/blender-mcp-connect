...
.. class:: NodeEvaluateClosureInputItems(bpy_prop_collection)
   ...
   .. method:: new(socket_type, name)
      ...
      :rtype: :class:`NodeEvaluateClosureInputItem`
   ...
   .. method:: remove(item)
      ...
      :type item: :class:`NodeEvaluateClosureInputItem` | None
...
.. hlist::
   ...
   - :class:`NodeEvaluateClosure.input_items`
