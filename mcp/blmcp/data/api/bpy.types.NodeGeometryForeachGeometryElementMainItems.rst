...
.. class:: NodeGeometryForeachGeometryElementMainItems(bpy_prop_collection)
   ...
   .. method:: new(socket_type, name)
      ...
      :rtype: :class:`ForeachGeometryElementMainItem`
   ...
   .. method:: remove(item)
      ...
      :type item: :class:`ForeachGeometryElementMainItem` | None
...
.. hlist::
   ...
   - :class:`GeometryNodeForeachGeometryElementOutput.main_items`
