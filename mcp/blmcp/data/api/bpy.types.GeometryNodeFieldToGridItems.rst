...
.. class:: GeometryNodeFieldToGridItems(bpy_prop_collection)
   ...
   .. method:: new(socket_type, name)
      ...
      :rtype: :class:`GeometryNodeFieldToGridItem`
   ...
   .. method:: remove(item)
      ...
      :type item: :class:`GeometryNodeFieldToGridItem` | None
...
.. hlist::
   ...
   - :class:`GeometryNodeFieldToGrid.grid_items`
