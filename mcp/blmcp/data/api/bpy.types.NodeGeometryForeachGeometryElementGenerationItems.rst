...
.. class:: NodeGeometryForeachGeometryElementGenerationItems(bpy_prop_collection)
   ...
   .. method:: new(socket_type, name)
      ...
      :rtype: :class:`ForeachGeometryElementGenerationItem`
   ...
   .. method:: remove(item)
      ...
      :type item: :class:`ForeachGeometryElementGenerationItem` | None
...
.. hlist::
   ...
   - :class:`GeometryNodeForeachGeometryElementOutput.generation_items`
