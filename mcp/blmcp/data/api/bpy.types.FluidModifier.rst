...
.. class:: FluidModifier(Modifier)
   ...
   .. data:: domain_settings
      ...
      :type: :class:`FluidDomainSettings` | None

   .. data:: effector_settings

      (readonly)

      :type: :class:`FluidEffectorSettings` | None

   .. data:: flow_settings

      (readonly)

      :type: :class:`FluidFlowSettings` | None

   .. attribute:: fluid_type
      ...
      :type: Literal['NONE', 'DOMAIN', 'FLOW', 'EFFECTOR']
