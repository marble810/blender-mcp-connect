...
.. class:: MovieTrackingPlaneMarkers(bpy_prop_collection)
   ...
   .. method:: find_frame(frame, *, exact=True)
      ...
      :type frame: int
      :param exact: Exact, Get plane marker at exact frame number rather than get estimated marker (optional)
      :type exact: bool
   ...
   .. method:: delete_frame(frame)
      ...
      :param frame: Frame, Frame number to delete plane marker from (in [0, 1048574])
      :type frame: int
