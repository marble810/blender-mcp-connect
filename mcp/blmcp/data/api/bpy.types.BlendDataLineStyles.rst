...
.. class:: BlendDataLineStyles(bpy_prop_collection)
   ...
   .. method:: remove(linestyle, *, do_unlink=True, do_id_user=True, do_ui_user=True)
      ...
      :param linestyle: Line style to remove (never None)
      :type linestyle: :class:`FreestyleLineStyle` | None
      :param do_unlink: Unlink all usages of this line style before deleting it (optional)
      :type do_unlink: bool
      :param do_id_user: Decrement user counter of all data-blocks used by this line style (optional)
      :type do_id_user: bool
      :param do_ui_user: Make sure interface does not reference this line style (optional)
