...
.. class:: NodeCombineBundleItems(bpy_prop_collection)
   ...
   .. method:: new(socket_type, name)
      ...
      :rtype: :class:`NodeCombineBundleItem`
   ...
   .. method:: remove(item)
      ...
      :type item: :class:`NodeCombineBundleItem` | None
...
.. hlist::
   ...
   - :class:`NodeCombineBundle.bundle_items`
