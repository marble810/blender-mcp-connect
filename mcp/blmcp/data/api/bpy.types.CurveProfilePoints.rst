...
.. class:: CurveProfilePoints(bpy_prop_collection)
   ...
   .. method:: add(x, y)
      ...
      :param x: X Position, X Position for new point (in [-inf, inf])
      :type x: float
      :param y: Y Position, Y Position for new point (in [-inf, inf])
      :type y: float
      :return: New point
      :rtype: :class:`CurveProfilePoint`
   ...
   .. method:: remove(point)
      ...
      :type point: :class:`CurveProfilePoint` | None
