...
.. class:: GeometryNodeFieldToListItems(bpy_prop_collection)
   ...
   .. method:: new(socket_type, name)
      ...
      :rtype: :class:`GeometryNodeFieldToListItem`
   ...
   .. method:: remove(item)
      ...
      :type item: :class:`GeometryNodeFieldToListItem` | None
...
.. hlist::
   ...
   - :class:`GeometryNodeFieldToList.list_items`
