...
.. hlist::
   ...
   - :class:`ImageStrip.retiming_keys`
   - :class:`MovieStrip.retiming_keys`
   - :class:`RetimingKeys.add`
   - :class:`SceneStrip.retiming_keys`
   - :class:`SoundStrip.retiming_keys`
