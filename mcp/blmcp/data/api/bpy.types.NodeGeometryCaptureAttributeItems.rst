...
.. class:: NodeGeometryCaptureAttributeItems(bpy_prop_collection)
   ...
   .. method:: new(socket_type, name)
      ...
      :rtype: :class:`NodeGeometryCaptureAttributeItem`
   ...
   .. method:: remove(item)
      ...
      :type item: :class:`NodeGeometryCaptureAttributeItem` | None
...
.. hlist::
   ...
   - :class:`GeometryNodeCaptureAttribute.capture_items`
