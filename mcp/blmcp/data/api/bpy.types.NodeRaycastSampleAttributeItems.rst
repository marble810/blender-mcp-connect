...
.. class:: NodeRaycastSampleAttributeItems(bpy_prop_collection)
   ...
   .. method:: new(socket_type, name)
      ...
      :rtype: :class:`NodeRaycastSampleAttributeItem`
   ...
   .. method:: remove(item)
      ...
      :type item: :class:`NodeRaycastSampleAttributeItem` | None
...
.. hlist::
   ...
   - :class:`ShaderNodeRaycast.sample_attribute_items`
