...
.. class:: GeometryNodeForeachGeometryElementOutput(GeometryNode)
   ...
   .. attribute:: active_generation_index

      Index of the active item (in [0, inf], default 0)

      :type: int

   .. attribute:: active_input_index

      Index of the active item (in [0, inf], default 0)

      :type: int

   .. attribute:: active_main_index
   ...
   .. data:: generation_items
      ...
      :type: :class:`NodeGeometryForeachGeometryElementGenerationItems`\ [:class:`ForeachGeometryElementGenerationItem`]

   .. data:: input_items

      (default None, readonly)

      :type: :class:`NodeGeometryForeachGeometryElementInputItems`\ [:class:`ForeachGeometryElementInputItem`]

   .. attribute:: inspection_index
   ...
   .. data:: main_items
      ...
      :type: :class:`NodeGeometryForeachGeometryElementMainItems`\ [:class:`ForeachGeometryElementMainItem`]
