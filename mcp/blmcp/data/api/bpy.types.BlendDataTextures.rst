...
.. class:: BlendDataTextures(bpy_prop_collection)
   ...
   .. method:: new(name, type)
      ...
      :type type: Literal[:ref:`rna_enum_texture_type_items`]
   ...
   .. method:: remove(texture, *, do_unlink=True, do_id_user=True, do_ui_user=True)
      ...
      :param texture: Texture to remove (never None)
      :type texture: :class:`Texture` | None
      :param do_unlink: Unlink all usages of this texture before deleting it (optional)
      :type do_unlink: bool
      :param do_id_user: Decrement user counter of all data-blocks used by this texture (optional)
      :type do_id_user: bool
      :param do_ui_user: Make sure interface does not reference this texture (optional)
