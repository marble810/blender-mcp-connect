...
.. class:: NodeSeparateBundleItems(bpy_prop_collection)
   ...
   .. method:: new(socket_type, name)
      ...
      :rtype: :class:`NodeSeparateBundleItem`
   ...
   .. method:: remove(item)
      ...
      :type item: :class:`NodeSeparateBundleItem` | None
...
.. hlist::
   ...
   - :class:`NodeSeparateBundle.bundle_items`
