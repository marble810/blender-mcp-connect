...
.. class:: MaskSplines(bpy_prop_collection)
   ...
   .. attribute:: active
      ...
      :type: :class:`MaskSpline` | None

   .. attribute:: active_point

      Active point of masking layer

      :type: :class:`MaskSplinePoint` | None
   ...
   .. method:: remove(spline)
      ...
      :type spline: :class:`MaskSpline` | None
