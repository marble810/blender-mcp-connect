...
.. class:: LineStyleGeometryModifiers(bpy_prop_collection)
   ...
   .. method:: new(name, type)
      ...
      :param name: New name for the geometry modifier (not unique) (never None)
      :type name: str
   ...
   .. method:: remove(modifier)
      ...
      :type modifier: :class:`LineStyleGeometryModifier` | None
