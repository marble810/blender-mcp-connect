...
.. class:: GeometryNodeViewer(GeometryNode)
   ...
   .. attribute:: active_item
      ...
      :type: :class:`NodeGeometryViewerItem` | None

   .. attribute:: domain

      Domain to evaluate fields on (default ``'POINT'``)

      :type: Literal[:ref:`rna_enum_attribute_domain_with_auto_items`]

   .. attribute:: ui_shortcut
   ...
   .. data:: viewer_items
      ...
      :type: :class:`NodeGeometryViewerItems`\ [:class:`NodeGeometryViewerItem`]
