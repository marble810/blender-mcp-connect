...
.. class:: FModifierEnvelopeControlPoints(bpy_prop_collection)
   ...
   .. method:: add(frame)
      ...
      :param frame: Frame to add this control-point (in [-inf, inf])
      :type frame: float
   ...
   .. method:: remove(point)
      ...
      :type point: :class:`FModifierEnvelopeControlPoint` | None
