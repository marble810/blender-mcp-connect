...
.. class:: NodeGeometryBakeItems(bpy_prop_collection)
   ...
   .. method:: new(socket_type, name)
      ...
      :rtype: :class:`NodeGeometryBakeItem`
   ...
   .. method:: remove(item)
      ...
      :type item: :class:`NodeGeometryBakeItem` | None
...
.. hlist::
   ...
   - :class:`GeometryNodeBake.bake_items`
