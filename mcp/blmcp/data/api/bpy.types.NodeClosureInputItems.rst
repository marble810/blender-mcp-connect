...
.. class:: NodeClosureInputItems(bpy_prop_collection)
   ...
   .. method:: new(socket_type, name)
      ...
      :rtype: :class:`NodeClosureInputItem`
   ...
   .. method:: remove(item)
      ...
      :type item: :class:`NodeClosureInputItem` | None
...
.. hlist::
   ...
   - :class:`NodeClosureOutput.input_items`
