...
.. class:: TransformOrientationSlot(bpy_struct)
   ...
   .. data:: custom_orientation

      (readonly)

      :type: :class:`TransformOrientation` | None

   .. attribute:: type

      Transformation orientation (default ``'GLOBAL'``)

      :type: Literal[:ref:`rna_enum_transform_orientation_items`]
...
.. hlist::
   ...
   - :class:`Scene.transform_orientation_slots`
