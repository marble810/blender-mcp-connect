...
.. class:: PointCloud(ID)
   ...
   .. data:: attributes
      ...
      :type: :class:`AttributeGroupPointCloud`\ [:class:`Attribute`]
   ...
   .. data:: points
      ...
      :type: :class:`bpy_prop_collection`\ [:class:`Point`]

   .. method:: resize(size)

      resize

      :param size: Size, New number of points (in [0, inf])
      :type size: int
...
.. hlist::
   ...
   - :mod:`bpy.context.pointcloud`
   - :class:`BlendData.pointclouds`
   - :class:`BlendDataPointClouds.new`
   - :class:`BlendDataPointClouds.remove`
