...
.. class:: BlendDataWorlds(bpy_prop_collection)
   ...
   .. method:: remove(world, *, do_unlink=True, do_id_user=True, do_ui_user=True)
      ...
      :param world: World to remove (never None)
      :type world: :class:`World` | None
      :param do_unlink: Unlink all usages of this world before deleting it (optional)
      :type do_unlink: bool
      :param do_id_user: Decrement user counter of all data-blocks used by this world (optional)
      :type do_id_user: bool
      :param do_ui_user: Make sure interface does not reference this world (optional)
