...
.. class:: NlaTracks(bpy_prop_collection)
   ...
   .. attribute:: active
      ...
      :type: :class:`NlaTrack` | None

   .. method:: new(*, prev=None)

      Add a new NLA Track

      :param prev: NLA Track to add the new one after (optional)
      :type prev: :class:`NlaTrack` | None
   ...
   .. method:: remove(track)
      ...
      :type track: :class:`NlaTrack` | None
