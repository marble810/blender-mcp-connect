...
.. class:: NlaStrips(bpy_prop_collection)
   ...
   .. method:: new(name, start, action)
      ...
      :type name: str
      :param start: Start Frame, Start frame for this strip (in [-inf, inf])
      :type start: int
      :param action: Action to assign to this strip (never None)
   ...
   .. method:: remove(strip)
      ...
      :type strip: :class:`NlaStrip` | None
