...
.. class:: GeometryNodeClosureToListItems(bpy_prop_collection)
   ...
   .. method:: new(socket_type, name)
      ...
      :rtype: :class:`GeometryNodeClosureToListItem`
   ...
   .. method:: remove(item)
      ...
      :type item: :class:`GeometryNodeClosureToListItem` | None
...
.. hlist::
   ...
   - :class:`GeometryNodeClosureToList.list_items`
