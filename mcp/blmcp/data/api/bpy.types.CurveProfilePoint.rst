...
.. class:: CurveProfilePoint(bpy_struct)
   ...
   .. attribute:: handle_type_1

      Path interpolation at this point (default ``'FREE'``)

      :type: Literal['AUTO', 'VECTOR', 'FREE', 'ALIGN']

   .. attribute:: handle_type_2
...
.. hlist::
   ...
   - :class:`CurveProfile.segments`
   - :class:`CurveProfilePoints.add`
   - :class:`CurveProfilePoints.remove`
