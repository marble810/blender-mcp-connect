...
.. class:: GeometryNodeBoneInfo(GeometryNode)
   ...
   .. attribute:: transform_space
      ...
      - ``ORIGINAL``
        Original -- Output the bone pose relative to the armature object transform.
      - ``RELATIVE``
        Relative -- Bring the bone pose into the modified object.

      :type: Literal['ORIGINAL', 'RELATIVE']
