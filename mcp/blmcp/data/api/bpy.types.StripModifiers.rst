...
.. class:: StripModifiers(bpy_prop_collection)
   ...
   .. attribute:: active
      ...
      :type: :class:`StripModifier` | None

   .. method:: new(name, type)

      Add a new modifier

      :param name: New name for the modifier (never None)
      :type name: str
      :param type: Modifier type to add
      :type type: Literal[:ref:`rna_enum_strip_modifier_type_items`]
      :return: Newly created modifier
      :rtype: :class:`StripModifier`
   ...
   .. method:: remove(modifier)
      ...
      :type modifier: :class:`StripModifier` | None
