...
.. class:: XrComponentPaths(bpy_prop_collection)
   ...
   .. method:: new(path)
      ...
      :rtype: :class:`XrComponentPath`

   .. method:: remove(component_path)

      remove

      :param component_path: Component Path, (never None)
      :type component_path: :class:`XrComponentPath` | None
...
.. hlist::
   ...
   - :class:`XrActionMapBinding.component_paths`
