...
.. class:: NodeClosureOutputItems(bpy_prop_collection)
   ...
   .. method:: new(socket_type, name)
      ...
      :rtype: :class:`NodeClosureOutputItem`
   ...
   .. method:: remove(item)
      ...
      :type item: :class:`NodeClosureOutputItem` | None
...
.. hlist::
   ...
   - :class:`NodeClosureOutput.output_items`
