...
.. class:: ShaderNodeMix(ShaderNode)
   ...
   .. attribute:: clamp_factor

      Clamp the factor to [0,1] range (default False)

      :type: bool

   .. attribute:: clamp_result
   ...
   .. attribute:: data_type
      ...
      :type: Literal['FLOAT', 'VECTOR', 'RGBA', 'ROTATION']

   .. attribute:: factor_mode

      (default ``'UNIFORM'``)

      - ``UNIFORM``
        Uniform -- Use a single factor for all components.
      - ``NON_UNIFORM``
        Non-Uniform -- Per component factor.
