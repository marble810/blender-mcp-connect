...
.. class:: NodeEvaluateClosureOutputItems(bpy_prop_collection)
   ...
   .. method:: new(socket_type, name)
      ...
      :rtype: :class:`NodeEvaluateClosureOutputItem`
   ...
   .. method:: remove(item)
      ...
      :type item: :class:`NodeEvaluateClosureOutputItem` | None
...
.. hlist::
   ...
   - :class:`NodeEvaluateClosure.output_items`
