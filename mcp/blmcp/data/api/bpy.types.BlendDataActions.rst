...
.. class:: BlendDataActions(bpy_prop_collection)
   ...
   .. method:: remove(action, *, do_unlink=True, do_id_user=True, do_ui_user=True)
      ...
      :param action: Action to remove (never None)
      :type action: :class:`Action` | None
      :param do_unlink: Unlink all usages of this action before deleting it (optional)
      :type do_unlink: bool
      :param do_id_user: Decrement user counter of all data-blocks used by this action (optional)
      :type do_id_user: bool
      :param do_ui_user: Make sure interface does not reference this action (optional)
