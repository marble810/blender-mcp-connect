...
.. class:: MovieTrackingObjectTracks(bpy_prop_collection)
   ...
   .. attribute:: active
      ...
      :type: :class:`MovieTrackingTrack` | None
   ...
   .. method:: new(*, name="", frame=1)
      ...
      :type name: str
      :param frame: Frame, Frame number to add tracks on (in [0, 1048574], optional)
      :type frame: int
