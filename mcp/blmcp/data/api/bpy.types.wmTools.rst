...
.. class:: wmTools(bpy_prop_collection)
   ...
   .. method:: from_space_view3d_mode(mode, *, create=False)
      ...
      :type create: bool
      :rtype: :class:`WorkSpaceTool`

   .. method:: from_space_image_mode(mode, *, create=False)
   ...
   .. method:: from_space_node(*, create=False)
   ...
   .. method:: from_space_sequencer(mode, *, create=False)
