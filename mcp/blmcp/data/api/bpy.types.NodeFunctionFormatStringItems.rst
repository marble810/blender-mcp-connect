...
.. class:: NodeFunctionFormatStringItems(bpy_prop_collection)
   ...
   .. method:: new(socket_type, name)
      ...
      :rtype: :class:`NodeFunctionFormatStringItem`
   ...
   .. method:: remove(item)
      ...
      :type item: :class:`NodeFunctionFormatStringItem` | None
...
.. hlist::
   ...
   - :class:`FunctionNodeFormatString.format_items`
