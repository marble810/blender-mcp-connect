...
.. class:: NodeGeometryViewerItems(bpy_prop_collection)
   ...
   .. method:: new(socket_type, name)
      ...
      :rtype: :class:`NodeGeometryViewerItem`
   ...
   .. method:: remove(item)
      ...
      :type item: :class:`NodeGeometryViewerItem` | None
...
.. hlist::
   ...
   - :class:`GeometryNodeViewer.viewer_items`
