...
.. hlist::
   ...
   - :class:`GeometryNodeSimulationOutput.active_item`
   - :class:`GeometryNodeSimulationOutput.state_items`
   - :class:`NodeGeometrySimulationOutputItems.new`
   - :class:`NodeGeometrySimulationOutputItems.remove`
