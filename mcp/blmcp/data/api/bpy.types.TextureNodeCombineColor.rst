...
base classes --- :class:`bpy_struct`, :class:`Node`, :class:`NodeInternal`, :class:`TextureNode`
...
.. class:: TextureNodeCombineColor(TextureNode)
   ...
   .. attribute:: mode
      ...
      :type: Literal[:ref:`rna_enum_node_combsep_color_items`]
...
.. hlist::
   ...
   - :class:`TextureNode.poll`
   - :class:`TextureNode.bl_rna_get_subclass`
   - :class:`TextureNode.bl_rna_get_subclass_py`
